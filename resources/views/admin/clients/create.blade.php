...
@section('title', 'Add New Client - Professional Inspection Services')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('client_code') is-invalid @enderror" 
                                       id="client_code" name="client_code" value="{{ old('client_code') }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('industry') is-invalid @enderror" 
                                    ...
                                    <option value="Marine/Offshore" {{ old('industry') === 'Marine/Offshore' ? 'selected' : '' }}>Marine/Offshore</option>
                                    <option value="Power Generation" {{ old('industry') === 'Power Generation' ? 'selected' : '' }}>Power Generation</option>
                                    ...
                                    <option value="Chemical" {{ old('industry') === 'Chemical' ? 'selected' : '' }}>Chemical</option>
