        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select class="form-select" id="drop_type" name="drop_type">
                    ...
                    <option value="freely" selected>Drop freely</option>
                    <option value="controlled">Controlled drop</option>
                    <option value="guided">Guided drop</option>
                </select>
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" 
                          ...
                          name="drop_notes" 
                          rows="3" 
                          placeholder="Enter any additional observations or notes about the drop test..."></textarea>
