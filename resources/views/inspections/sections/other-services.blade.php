...
<div class="form-section" id="section-other-services">
    ...
    <div class="section-content">
        ...
        <!-- Sub-Service Forms (hidden by default, shown when selected) -->
        <div id="subServiceForms" class="mt-4">
            <div id="dropTestFormSection" style="display:none;">
                @include('inspections.sections.drop-test')
            </div>
            <div id="tiltTestFormSection" style="display:none;">
                @include('inspections.sections.tilt-test')
            </div>
            <div id="loweringTestFormSection" style="display:none;">
                @include('inspections.sections.lowering-test')
            </div>
        </div>
    </div>
</div>
