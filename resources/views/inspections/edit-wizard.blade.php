            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">
                        ...
                        Edit Inspection Report #{{ $inspection->id }}
                    </h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="step-content">
                        ...
                        <form method="POST" action="{{ route('inspections.edit-wizard.save', $inspection->id) }}" enctype="multipart/form-data" id="wizardForm">
                            @csrf
                            <input type="hidden" name="step" value="{{ $currentStep }}">
                            <input type="hidden" name="inspection_id" value="{{ $inspection->id }}">
                            
                            @include("inspections.edit-wizard.step{$currentStep}", [
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <div>
                                    @if($currentStep > 1)
                                        <a href="{{ route('inspections.edit-wizard.step', ['inspection' => $inspection->id, 'step' => $currentStep - 1]) }}" 
